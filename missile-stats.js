class Missile {
  constructor({ name, scalingFactor, sprintStage, speedBounds, socketBounds, maneuverBounds, flightTimeBounds }) {
    this.name = name;
    this.scalingFactor = scalingFactor;
    this.sprintStage = sprintStage;
    this.speedBounds = speedBounds;
    this.socket = socketBounds;
